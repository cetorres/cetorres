...
| --- | --- | --- |
| [notes-app-pocketbase](https://github.com/cetorres/notes-app-pocketbase) | A full stack Notes app that uses PocketBase as the backend and a pure JavaScript frontend. See it running on <https://notes.cetorres.com>. | HTML, JS, CSS, PocketBase |
